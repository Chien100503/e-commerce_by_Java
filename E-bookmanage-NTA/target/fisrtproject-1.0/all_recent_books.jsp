<%-- 
    ...
    Created on : Apr 11, 2024, 11:34:33 PM
    Author     : Admin
--%>
        ...
        <div class = "container-fluid">
            <div class = "row">
                <%
                    ...
                    List<BookDtls> books = dao.getAllRecentBook();
                    for (BookDtls book : books) {
                %>
                <div class="col-md-3 justify-content-center" style="left: 70px">
                    <div class="card card-hov">
                        <div class="card-body text-center">
                            <img alt="" src="books/<%=book.getPhotoName()%>" style="width: 200; height: 250px" class="img-thumblin">
                            ...
                            <p>
                                ...
                                %>
                                Categorie: <%=book.getBookCategory()%></p>
                            <div class="row">   
